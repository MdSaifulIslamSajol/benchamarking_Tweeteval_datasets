...
# https://www.kaggle.com/datasets/thedevastator/tweeteval-a-multi-task-classification-benchmark?select=irony_train.csv
import numpy as np
import pandas as pd
import transformers
...
hate_train = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/hate_train.csv")
# Display the first few rows of the dataframe
print(hate_train.head())

# Separate the dataframe into two dataframes
train_text = hate_train[['text']].copy()  # Retain the 'text' column with the header
train_labels = hate_train[['label']].copy()  # Retain the 'label' column with the header
...
# val
# Load the text file using pandas
hate_validation = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/hate_validation.csv")
# Display the first few rows of the dataframe
print(hate_validation.head())

# Separate the dataframe into two dataframes
val_text = hate_validation[['text']].copy()  # Retain the 'text' column with the header
val_labels = hate_validation[['label']].copy()  # Retain the 'label' column with the header
...
## ## test
# Load the text file using pandas
hate_test = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/hate_test.csv")
# Display the first few rows of the dataframe
print(hate_test.head())

# Separate the dataframe into two dataframes
test_text = hate_test[['text']].copy()  # Retain the 'text' column with the header
test_labels = hate_test[['label']].copy()  # Retain the 'label' column with the header
...
optimizer = AdamW(model.parameters(), lr=1e-2)  # learning rate
