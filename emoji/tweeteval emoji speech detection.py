...
# https://www.kaggle.com/datasets/thedevastator/tweeteval-a-multi-task-classification-benchmark?select=emoji_train.csv
import os
...
emoji_train = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/emoji_train.csv")
# Display the first few rows of the dataframe
print(emoji_train.head())

# Separate the dataframe into two dataframes
train_text = emoji_train[['text']].copy()  # Retain the 'text' column with the header
train_labels = emoji_train[['label']].copy()  # Retain the 'label' column with the header
...
# val
# Load the text file using pandas
emoji_validation = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/emoji_validation.csv")
# Display the first few rows of the dataframe
print(emoji_validation.head())

# Separate the dataframe into two dataframes
val_text = emoji_validation[['text']].copy()  # Retain the 'text' column with the header
val_labels = emoji_validation[['label']].copy()  # Retain the 'label' column with the header
...
## ## test
# Load the text file using pandas
emoji_test = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/emoji_test.csv")
# Display the first few rows of the dataframe
print(emoji_test.head())

# Separate the dataframe into two dataframes
test_text = emoji_test[['text']].copy()  # Retain the 'text' column with the header
test_labels = emoji_test[['label']].copy()  # Retain the 'label' column with the header
...
class BERT_Arch(nn.Module):
    def __init__(self, bert):
        ...
        self.fc2 = nn.Linear(512, 20)  # dense layer 2 (Output layer)
...
for param in model.parameters():
    ...
    print(f'Parameter {param}: requires_grad set to {param.requires_grad}')
