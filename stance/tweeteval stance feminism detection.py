...
# https://www.kaggle.com/datasets/thedevastator/tweeteval-a-multi-task-classification-benchmark?select=stance_feminist_train.csv
import numpy as np
import pandas as pd
import transformers
...
stance_feminist_train = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/stance_feminist_train.csv")
# Display the first few rows of the dataframe
print(stance_feminist_train.head())

# Separate the dataframe into two dataframes
train_text = stance_feminist_train[['text']].copy()  # Retain the 'text' column with the header
train_labels = stance_feminist_train[['label']].copy()  # Retain the 'label' column with the header
...
# val
# Load the text file using pandas
stance_feminist_validation = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/stance_feminist_validation.csv")
# Display the first few rows of the dataframe
print(stance_feminist_validation.head())

# Separate the dataframe into two dataframes
val_text = stance_feminist_validation[['text']].copy()  # Retain the 'text' column with the header
val_labels = stance_feminist_validation[['label']].copy()  # Retain the 'label' column with the header
...
## ## test
# Load the text file using pandas
stance_feminist_test = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/stance_feminist_test.csv")
# Display the first few rows of the dataframe
print(stance_feminist_test.head())

# Separate the dataframe into two dataframes
test_text = stance_feminist_test[['text']].copy()  # Retain the 'text' column with the header
test_labels = stance_feminist_test[['label']].copy()  # Retain the 'label' column with the header
...
optimizer = AdamW(model.parameters(), lr=1e-1)  # learning rate
