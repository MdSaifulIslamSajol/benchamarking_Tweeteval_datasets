...
import sys
sys.stdout = open(f"climate_stance_speech_console_output_lr_{learning_rate}_CE.txt", "w")
...
offensive_train = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/stance_climate_train.csv")
...
# val
# Load the text file using pandas
offensive_validation = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/stance_climate_validation.csv")
# Display the first few rows of the dataframe
...
## ## test
# Load the text file using pandas
offensive_test = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/stance_climate_test.csv")
# Display the first few rows of the dataframe
