...
# https://www.kaggle.com/datasets/thedevastator/tweeteval-a-multi-task-classification-benchmark?select=stance_abortion_train.csv
import numpy as np
import pandas as pd
import transformers
...
print(stance_abortion_train.head())

# Separate the dataframe into two dataframes
train_text = stance_abortion_train[['text']].copy()  # Retain the 'text' column with the header
train_labels = stance_abortion_train[['label']].copy()  # Retain the 'label' column with the header
...
# Display the first few rows of the dataframe
print(stance_abortion_validation.head())

# Separate the dataframe into two dataframes
val_text = stance_abortion_validation[['text']].copy()  # Retain the 'text' column with the header
val_labels = stance_abortion_validation[['label']].copy()  # Retain the 'label' column with the header
...
# Display the first few rows of the dataframe
print(stance_abortion_test.head())

# Separate the dataframe into two dataframes
test_text = stance_abortion_test[['text']].copy()  # Retain the 'text' column with the header
test_labels = stance_abortion_test[['label']].copy()  # Retain the 'label' column with the header
