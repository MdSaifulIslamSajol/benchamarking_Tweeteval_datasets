...
# https://www.kaggle.com/datasets/thedevastator/tweeteval-a-multi-task-classification-benchmark?select=offensive_train.csv
import numpy as np
import pandas as pd
import transformers
...
offensive_train = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/offensive_train.csv")
...
# val
# Load the text file using pandas
offensive_validation = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/offensive_validation.csv")
# Display the first few rows of the dataframe
...
## ## test
# Load the text file using pandas
offensive_test = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/offensive_test.csv")
# Display the first few rows of the dataframe
