...
irony_train = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/irony_train.csv")
# Display the first few rows of the dataframe
print(irony_train.head())

# Separate the dataframe into two dataframes
train_text = irony_train[['text']].copy()  # Retain the 'text' column with the header
train_labels = irony_train[['label']].copy()  # Retain the 'label' column with the header
...
# val
# Load the text file using pandas
irony_validation = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/irony_validation.csv")
# Display the first few rows of the dataframe
print(irony_validation.head())

# Separate the dataframe into two dataframes
val_text = irony_validation[['text']].copy()  # Retain the 'text' column with the header
val_labels = irony_validation[['label']].copy()  # Retain the 'label' column with the header
...
## ## test
# Load the text file using pandas
irony_test = pd.read_csv("/home/saiful/bangla fault news/tweeteval/tweeteval kaggle/irony_test.csv")
# Display the first few rows of the dataframe
print(irony_test.head())

# Separate the dataframe into two dataframes
test_text = irony_test[['text']].copy()  # Retain the 'text' column with the header
test_labels = irony_test[['label']].copy()  # Retain the 'label' column with the header
